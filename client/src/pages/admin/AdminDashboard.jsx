    ...
    <div className="min-h-screen bg-gray-100 flex">
      ...
      <aside className="w-64 bg-gray-900 text-white min-h-screen hidden md:flex flex-col">
        ...
        <nav className="flex-1 px-4 py-6 space-y-2">
          ...
          {/* Skills */}
          <button
            onClick={() => navigate("/admin/skills/manage")}
            className="w-full flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-gray-800 transition"
          >
            <Wrench size={20} />
      ...
      <main className="flex-1">
        ...
        <section className="p-6">
          ...
          <div className="bg-white rounded-xl shadow-sm p-6 mb-6">
            ...
            <p className="text-gray-500 mt-2">
              From here you can manage the projects and
              skills displayed on your portfolio website.
            </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              ...
              <button
                ...
                className="mt-3 flex items-center gap-2 border border-gray-300 hover:bg-gray-100 text-gray-700 px-4 py-2.5 rounded-lg transition"
              >
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              ...
              <button
                ...
                className="mt-4 flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white px-4 py-2.5 rounded-lg transition"
              >
              ...
              <div className="bg-white rounded-xl shadow-sm p-6">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">
                      Add, edit and remove your technical skills.
                    </p>
