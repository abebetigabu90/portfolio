...
//             {error && (
//               <div className="mb-5 rounded-lg bg-red-50
...
//             {success && (
//               <div className="mb-5 rounded-lg bg-green-50
...
//                   Enter the icon/technology name that the frontend
//                   will use to display the appropriate icon.
//                 </p>
//               </div>
