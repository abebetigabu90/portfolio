...
// const LEVEL_CONFIG = {
//   Advanced: { width: "w-[90%]", color: "bg-blue-500" },
//   Intermediate: { width: "w-[65%]", color: "bg-purple-500" },
//   Beginner: { width: "w-[40%]", color: "bg-slate-400" },
// };
...
//             Technologies and tools I have used while building web applications
...
//             <p className="text-slate-500 font-medium">No skills available.</p>
//           </div>
//         ) : (
...
//                 <div
//                   key={skill._id}
//                   className="group rounded-2xl border border-slate-800 bg-slate-900/90 p-6 shadow-xl transition-all duration-300 hover:-translate-y-1 hover:border-slate-700 hover:shadow-2xl"
//                 >
...
//                     {skill.featured && (
//                       <span className="inline-flex items-center rounded-full bg-amber-500/90 px-2.5 py-0.5 text-xs font-semibold text-slate-950 shadow-sm">
//                         ★ Featured
//                       </span>
//                     )}
//                   </div>
...
//                     <div
//                       className={`h-full rounded-full transition-all duration-500 ${config.width} ${config.color}`}
//                     />
//                   </div>
//                 </div>
//               );
